...
The ST+I model includes both the national temporal trends and the region-specific deviations, with the residual RRs of interaction term capturing how each region’s temporal pattern differs from the overall trend (Supplementary Figure 4).
