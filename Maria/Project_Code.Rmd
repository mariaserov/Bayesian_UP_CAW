...
reg_table <- knitr::kable(year_agg_vis, format="latex", caption = "Yearly summary of crude crime rates (per 100,000 women)") %>%
...
# render  with borders
sensitivity_priors <- kable(prior_settings, format = "latex", escape = FALSE, align = "c",
...
sensitivity <- kable(results, format="latex", caption = "Sensitivity Analysis Results for Spatio-temporal Models with Interaction I") %>% kable_styling(bootstrap_options = "striped", full_width = F, position = "center")
```
...
waic_table = knitr::kable(WAIC_df, format = "latex", caption = "Table 1: WAIC for Different Models and Crimes") %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "center")
waic_table
...
stInt_hyper = kable(hyper_wide, format="latex", booktabs = TRUE, caption = "Table 2:Posterior Summaries of Hyperparameters") %>%
