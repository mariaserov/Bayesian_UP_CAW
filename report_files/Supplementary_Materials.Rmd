...
4. Results visualisation: the code used to produce additional figures, and compile all the figures into the visualisation file that was used in the report. 
